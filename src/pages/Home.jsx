...
export default function Home() {
  return <Layout>
    ...
    <section className="trust-band"><div className="container-x"><h2>Why Patients Choose Ouransh</h2><div className="trust-grid">{reasons.map(r=><div key={r.title}><div className="trust-icon"><Icon type={r.icon}/></div><div><b>{r.title}</b><p>{r.text}</p></div></div>)}</div></div></section>
